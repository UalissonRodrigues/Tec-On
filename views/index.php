...
<body data-spy="scroll" data-target="#header" data-offset="51">
    ...
    <div id="page-container" class="fade">
            ...
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand">
                    ...
                    <span class="brand-text">
                        <span class="text-primary">Tec-ON</span>
                    </span>
                </a>
                <!-- end navbar-brand -->
                <!-- begin navbar-toggle -->
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item"><a class="nav-link" href="#about" data-click="scroll-to-target">Historia</a></li>
                        <li class="nav-item"><a class="nav-link" href="#team" data-click="scroll-to-target">Nosso Time</a></li>
        ...
        <div id="home" class="content has-bg home">
            <!-- begin content-bg -->
            <div class="content-bg" style="background-image: url(../Public/imagem/teste.jpg);" data-paroller="true" data-paroller-factor="0.5" data-paroller-factor-xs="0.25">
            </div>
            <!-- end content-bg -->
        </div>
        <!-- end #home -->
            ...
            <div class="container" data-animation="true" data-animation-type="fadeInDown">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <!-- begin about -->
                        <div class="about">
                            <h3 class="mb-3">Nossa Historia</h3>
                            <p>
                                Bem vindo a Tec-on, empresa que atua no seguimento de desenvolvimento WEB, nasceu
                                no ano de 2020 em meio uma Padandemia, onde as vendas online superou todas as expctativas de crescimento.
                            </p>
                            <p>
                                Empresa foi fundada por 2 irmãos no interior de São Paulo na cidade de Franca.
                            </p>
                        </div>
                        <!-- end about -->
                    </div>
                    ...
                    <!-- begin col-4 -->
                    <div class="col-md-4 col-sm-12">
                        <h3 class="mb-3">Nossa Filosofia</h3>
                        <!-- begin about-author -->
                        <div class="about-author">
                            <div class="quote">
                                <i class="fa fa-quote-left"></i>
                                <h3>Porporcionar uzabilidade e facilidade ao nosso usuario, resolvendo seu problema de forma simples.</span></h3>
                                <i class="fa fa-quote-right"></i>
                            </div>
                            <div class="author">
                                <div class="image">
                                    <img src=" ../Public/imagem/eu.jpg" alt="Sean Ngu" />
                                </div>
                                <div class="info">
                                    Ualisson
                    ...
                    <!-- begin col-4 -->
                    <div class="col-md-4 col-sm-12">
                        <h3 class="mb-3">Nossa Experiência</h3>
                        <!-- begin skills -->
                        <div class="skills">
                            ...
                            <div class="skills-name"> Linguagem - PHP</div>
                            <div class="progress mb-3">
        ...
        <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
            <!-- begin content-bg -->
            <div class="content-bg" data-paroller="true" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01"></div>
            <!-- end content-bg -->
            <!-- begin container -->
            <div class="container">
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="../Public/imagem/1.jpg" alt="Ualisson" />
                            </div>
                            <div class="info">
                                <h3 class="name">Ualisson Wagner</h3>
                                <div class="title text-primary">Fundador</div>
                                <p>Olá, sou um dos fundadores da TEc-on, empresa que busca solucionar o seu problema de forma simples</p>                                
                            </div>
                        </div>
                        <!-- end team -->
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="../Public/imagem/2.jpg" alt="Higor" />
                            </div>
                            <div class="info">
                                <h3 class="name">Higor Henrqiue</h3>
                                <div class="title text-primary">Socio Fundador</div>
                                <p>Olá, Sou irmão do Ualisson e socio fundador da Tec-On</p>                               
                            </div>
                        </div>
                        <!-- end team -->
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="team">
                            <div class="image" data-animation="true" data-animation-type="flipInX">
                                <img src="../Public/imagem/3.jpg" alt="Ana Laura" />
                            </div>
                            <div class="info">
                                <h3 class="name">Ana Laura</h3>
                                <div class="title text-primary">Administradora</div>
                                <p>Olá, sou resposavel pela parte administrativa da empresa Tec-on </p>
                                <div>
                                </div>
                                <!-- end team -->
                            </div>
                    ...
                    <div class="container" data-animation="true" data-animation-type="fadeInLeft">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 quote">
                                <i class="fa fa-quote-left"></i> A paixão leva ao design, o design leva ao desempenho, o
                                desempenho leva ao sucesso !  <span class="text-primary">sucesso</span>!
                                <i class="fa fa-quote-right"></i>
                                <small>Equipe de desenvolvedores Tec-on</small>
                            </div>
                            <!-- end col-12 -->
                        </div>
                        <!-- end row -->
